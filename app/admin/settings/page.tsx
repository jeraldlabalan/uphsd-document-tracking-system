...
export default function Settings() {
      ...
      // department option
      const departmentOptions: string[] = ["Select", "Engineering", "Business", "Information Technology", "Human Resource", "Medicine"];
                    ...
                    <div className={styles.informationContainer}>
                        ...
                        <form action="" method='' className={styles.informationForm} >
                            ...
                            <div className={styles.formData}>
                                ...
                                <input name='employeeId' placeholder='employee id' type="text" />
                            </div>  
                        ...
                        >
                          {option}
                            ...
                            <div className={styles.formData}>
                                ...
                                <textarea rows={3} name="bio" id=""></textarea>
                            </div>
                            </div>
                        ...
                        <div className={styles.allowedFileTypesSection}>
                            ...
                            <div className={styles.checkboxContainer}>
                                    ...
                                    <label htmlFor="spreadsheet">
                                        <input name='spreadsheet' id='spreadsheet' type="checkbox" />
                                        XLS / XLSX
                                    </label>
                                    <label htmlFor="img">
                    ...
                    <div className={styles.departmentManagementContainer}>
                        ...
                        <div className={styles.departmentContents}> 
                            ...
                            <div className={styles.addNewDepartmentContainer}>
                                ...
                                <input placeholder='Enter department name' name='department' id='department'  type="text" />
                            </div>
                        ...
                        <div className={styles.changePasswordContents}>
                            <div className={styles.changePasswordDataForm}>
                                <div className={styles.dataForm}>
                                    ...
                                    <input name='current' placeholder='Enter current password' type="text" />
                                </div>
                                <div className={styles.dataForm}>
                                    <label htmlFor="new">new password</label>
                                    <input name='new' placeholder='Enter current password' type="text" />
                                </div>
                                <div className={styles.dataForm}>
                                    <label htmlFor="confirm">confirm password</label>
                                    <input name='confirm' placeholder='Enter current password' type="text" />
                                </div>
                            </div>
